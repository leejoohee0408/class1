			...
			<div class="form-fields">
				<div class="form-row">
					<label for="상품코드">상품코드<span>*</span></label> <input type="text"
						name="p_sku"> <label for="상품명">상품명<span>*</span></label> <input
						type="text" name="p_sku1">
				</div>


				<div class="form-row">
					<label for="규격">규격<span>*</span></label> <input type="text"
						name="p_sku2"> <label for="업체명">업체명<span>*</span></label>
				...
				<div class="form-row">
					<label for="단가">단가<span>*</span></label> <input type="text"
						name="p_sku4"> <label for="제품분류">제품분류<span>*</span></label>
