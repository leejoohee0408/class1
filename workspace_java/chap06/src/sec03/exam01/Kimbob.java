...
/**
 * 김밥천국 관리 클래스
 *  (2024.12.10 최초생성) git이 이걸 해준다
 *  2024.12.11 메소드 수정
 *  by as106312@naver.com
 */
public class Kimbob {
...
//	int[] price;	// 메뉴와 순서를 맞춰서 관리하는 가격들
	...
	Kimbob(int seedMoney){
		...
		this.menu.add("소고기");
//		System.out.println(this.menu.get(0)); 직접하는거
//		for(int i=0; i<this.menu.size(); i++) {} for문으로 하는거
		this.price.add(3500);
	...
	void addMenu(String menuName, int menuPrice) {
		...
		System.out.println("메뉴 "+menuName+"("+menuPrice+")(을)추가했습니다.");
	}
